...
function affectLayout(ndUnit) {
  // console.log('ndUnit', ndUnit);
  // console.log('offsetHeight', ndUnit.offsetHeight);
  // console.log('offsetWidth', ndUnit.offsetWidth);
...
class HTMLEllipsis extends React.Component {
  ...
  reflow(props) {
    ...
    const basedOn =
        props.basedOn || (/^[\x00-\x7F]+$/.test(props.unsafeHTML) ? 'words' : 'letters');
  ...
  calcIndexes() {
    ...
    console.log('this.nlUnits', this.nlUnits);
  ...
  makeEllipsisSpan() {
    ...
    console.log('ndEllipsis', ndEllipsis);
