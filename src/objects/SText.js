...
const SText = fabric.util.createClass(fabric.Object, {
  type: 'SText',
  /**
  ...
  styleHas: function (property, lineIndex) {
    ...
    var obj =
      typeof lineIndex === 'undefined' ? this.styles : { 0: this.styles[lineIndex] };
 ...
 */
SText.ATTRIBUTE_NAMES = fabric.SHARED_ATTRIBUTES.concat(
 ...
 * @memberOf fabric.Text
 */
SText.DEFAULT_SVG_FONT_SIZE = 16;
 ...
 * @param {Object} [options] Options object
 */
SText.fromElement = function (element, callback, options) {
  if (!element) {
  ...
  */
  ...
  text.set({
    ...
    top:
      text.top -
      (textHeight - text.fontSize * (0.07 + text._fontSizeFraction)) / text.lineHeight,
 ...
 */
SText.fromObject = function (object, callback) {
  return fabric.Object._fromObject('Text', object, callback, 'text');
};

SText.genericFonts = ['sans-serif', 'serif', 'cursive', 'fantasy', 'monospace'];

fabric.util.createAccessors && fabric.util.createAccessors(SText);
