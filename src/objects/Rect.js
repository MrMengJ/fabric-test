...
const Rect = fabric.util.createClass(Text, {
  /**
   * List of properties to consider when checking if state of an object is changed ({@link fabric.Object#hasStateChanged})
   * as well as for history (undo/redo) purposes
   * @type Array
   */
  stateProperties: Text.prototype.stateProperties.concat('rx', 'ry'),
  ...
  cacheProperties: Text.prototype.cacheProperties.concat('rx', 'ry'),
